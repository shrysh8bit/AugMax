...
state_dict = torch.load('./checkpoint_sub/ckpt_eps3_f60_aug.pth')
...
random.seed(123)
subset_indices_adv = random.sample(set(list(np.arange(0,10000))).difference(set(subset_indices)),3000)
...
testloaderw = torch.utils.data.DataLoader(testset, batch_size=100, shuffle=False, num_workers=2)
