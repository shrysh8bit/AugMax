...
class Dataset(object):
    ...
    def __init__(self,confdata):
        ...
        #self.trainset = torchvision.datasets.CIFAR10(root='../track_cp/data/', train=True, download=True, transform=self.transform_train)
        ...
        #self.testset = torchvision.datasets.CIFAR10(root='../track_cp/data/', train=False, download=True,transform=self.transform_test)
        self.testset = torchvision.datasets.MNIST(root='./data/',train=False, transform=transform)
